...
try:
    ...
    if selected_products:
        ...
        # הצגת נתוני בדיקה
        st.write("### Debugging: Basket Prices")
        st.write(basket_prices)
        ...
        # הודעה אם 2024 לא מופיעה
        if "2024" not in filtered_years:
            st.warning("2024 is filtered out due to high basket price.")
